...
*/
    ...
    void getDetallePorIndicador(){
        ...
        */
        ...
        def c75 = SqlUtil.instance.getValorCampo(Aux.instance.diaTrabajoId, "AzucarGranel", "pol")
        setValor("PurProAzu", c75)
        
        def c76 = SqlUtil.instance.getValorCampo(Aux.instance.diaTrabajoId, "Mieles" , "mfSac")
        setValor("SacMel", c76)
        
        def c77 = SqlUtil.instance.getValorCampo(Aux.instance.diaTrabajoId, "Mieles" , "mfPur")
        setValor("PurProMel", c77)

        //f78=((C75*(M67-C77))/(M67*(C75-C77)))*100
        def m67 = SqlUtil.instance.getValorCampo(Aux.instance.diaTrabajoId, "StockProceso" , "pureza")
        def f78 = Calculo.instance.redondear(((c75*(m67-c77))/(m67*(c75-c77)))*100, 4)
        setValor("PorRecSjm", f78)

        def l67 = SqlUtil.instance.getValorCampo(Aux.instance.diaTrabajoId, "StockProceso" , "tonSac")
        ...
        def f83 = 0
        def d = SqlUtil.instance.getDetallePorDTI(Aux.instance.diaTrabajoId, "blc", "BlcDetalle12", "TonSacAzuHec")
        ...
        // TonSacMieFin
        def f86 = 0
        d = SqlUtil.instance.getDetallePorDTI(Aux.instance.diaTrabajoId, "blc", "BlcDetalle12", "TonSacMieFin")
